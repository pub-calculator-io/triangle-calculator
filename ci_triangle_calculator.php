...
Version: 1.0.0
Author: Triangle Calculator / www.calculator.io
...
function display_calcio_ci_triangle_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_triangle_calculator', 'display_calcio_ci_triangle_calculator' );